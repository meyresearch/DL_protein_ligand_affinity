...
def smile_to_graph(smile):
    ...
    file = open("/disk/scratch/Protein_ContactMaps_DL_BindingAffinity/DGraphDTA/data/kiba/ligands_can.txt", "r")
...
def create_dataset_for_test(dataset, method):
    # load dataset
    dataset_path = 'data/' + dataset + '/'
...
def create_dataset_for_test_bootstrap(dataset, method,random):
    # load dataset
    dataset_path = 'data/' + dataset + '/'
    test_fold = json.load(open(dataset_path + 'folds/test_fold_setting2.txt'))
    ##test_fold = json.load(open(dataset_path + 'folds/test_fold_setting1.txt'))
...
#             csv_file = 'data/' + dataset + '_' + 'fold_pconsc4_cmaps_' + str(fold) + '_' + opt + '.csv'
...
#     train_csv = 'data/' + dataset + '_' + 'fold_pconsc4_cmaps_' + str(fold) + '_' + 'train' + '.csv'
...
#     df_valid_fold = pd.read_csv('data/' + dataset + '_' + 'fold_pconsc4_cmaps_' + str(fold) + '_' + 'valid' + '.csv')
...
def create_dataset_for_5folds(dataset, fold, method):
    # load dataset
    dataset_path = 'data/' + dataset + '/'
