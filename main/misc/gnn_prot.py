...
#         self.mol_conv2 = GCNConv(num_features_mol, num_features_mol * 2)
#         self.mol_conv3 = GCNConv(num_features_mol * 2, num_features_mol * 4)
#         self.mol_conv4 = GCNConv(num_features_mol * 2, num_features_mol * 6)
#         self.mol_fc_g1 = torch.nn.Linear(num_features_mol * 6, 1024)
#         self.mol_fc_g2 = torch.nn.Linear(1024, 512)
#         self.mol_fc_g3 = torch.nn.Linear(512, output_dim)
